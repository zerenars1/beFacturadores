...
async function pago(params) {
  ...
  try {
    ...
    const ticket = await buildTicketBody({
      ...
      referenciaString: 'NRO.CELULAR/CUENTA',
    ...
    switch (e.response.data.code) {
      case 'pagserv0037':
        message = 'Claro Factura fija: El monto a pagar debe ser mayor a cero';
        break;
      case 'PS-B-008':
        message = 'Referencia no valida, Ej. para telefonía:09XXXXXXXX. Ej. para Claro TV 01XXXXXXX';
        break;
      case 'g1000':
