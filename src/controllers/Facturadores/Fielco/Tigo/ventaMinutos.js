...
async function validarPago(params, headers, data) {
  console.log(params.facturador.protocolo.concat(params.facturador.host_validacion));
  try {
...
async function pago(params) {
  ...
  try {
    ...
    switch (e.response.data.code) {
      case 'pgsrm0018':
        message = 'Monto no admitido; importes válidos: 2.000, 3.000, 5.000, 10.000, 15.000, 30.000, 35.000, 40.000, 50.000, 100.000';
        break;
      case 'pagserv0037':
        message = 'Tigo recarga: El monto a pagar debe ser mayor a cero';
        break;
      case 'g1000':
